...
class MyFoot extends StatelessWidget {
  ...
  factory MyFoot.fromJson(Map<String, dynamic> json) => _$MyFootFromJson(json);

  Map<String, dynamic> toJson() => _$MyFootToJson(this);

  /// 页脚文字
  String get footText =>
      // 作者
      (author.isNotEmpty ? '编辑人: $author' : '') +
      // 分割空格
      (author.isNotEmpty && time.isNotEmpty ? '  ' : '') +
      // 时间
      (time.isNotEmpty ? '时间: $time' : '');
