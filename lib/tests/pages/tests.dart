        ...
        children: [
          ListComponent(
            [
              ...
              ListComponentConfig('footer 测试', url: '/test/component/footer'),
              ListComponentConfig('carousel 测试',
                  url: '/test/component/carousel'),
              ListComponentConfig('MyPage 测试', path: '/guide/card/'),
            ],
            header: 'Class 测试',
          ),
          ListComponent(
            [
              ...
              ListComponentConfig('footer 测试',
                  url: '/test/component/footerJSON'),
              ListComponentConfig('carousel 测试',
